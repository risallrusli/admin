    ...
    <div class="srcollbar" data-simplebar>
        <ul class="menu" data-fc-type="accordion">
            ...
            <li class="menu-item">
                ...
                <ul class="sub-menu hidden">
                    <li class="menu-item">
                        <a href="{{ route('second', ['tables', 'rt']) }}" class="menu-link">
                            <span class="menu-text">RT</span>
                        </a>
                    </li>
                    <li class="menu-item">
                        <a href="{{ route('second', ['tables', 'nik']) }}" class="menu-link">
                            <span class="menu-text">NIK</span>
                        </a>
                    </li>
                    <li class="menu-item">
                        <a href="{{ route('second', ['tables', 'kk']) }}" class="menu-link">
                            <span class="menu-text">KK</span>
                        </a>
                    </li>
                    <li class="menu-item">
                        <a href="{{ route('second', ['tables', 'bulan']) }}" class="menu-link">
                            <span class="menu-text">BULAN</span>
                        </a>
                    </li>
                    <li class="menu-item">
                        <a href="{{ route('second', ['tables', 'tahun']) }}" class="menu-link">
                            <span class="menu-text">TAHUN</span>
                        </a>
                    </li>
                    <li class="menu-item">
                        <a href="{{ route('second', ['tables', 'pembayaran']) }}" class="menu-link">
                    ...
                    <li class="menu-item">
                        <a href="{{ route('second', ['tables', 'insert']) }}" class="menu-link">
                            <span class="menu-text"></span>
                        </a>
                    </li>
                    <li class="menu-item">
                        <a href="{{ route('second', ['tables', 'update']) }}" class="menu-link">
                            <span class="menu-text"></span>
                        </a>
                    </li>
                </ul>
